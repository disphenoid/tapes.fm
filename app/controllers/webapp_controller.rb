...
class WebappController < ApplicationController
  ...
  def explore
    ...
    @top = Tapedeck.desc(:created_at).excludes(:private => true).excludes(:active_tape_id => nil)

    @new = Tapedeck.desc(:created_at).excludes(:private => true).excludes(:active_tape_id => nil)
